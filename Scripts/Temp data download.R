...
url <- "https://s3-ap-southeast-2.amazonaws.com/silo-open-data/Official/annual/max_temp/2015.max_temp.nc"
tmp <- "test monthly raindata.nc"
curl_download(url, tmp)

for(i in 1989:2023){
  url <- paste0("https://s3-ap-southeast-2.amazonaws.com/silo-open-data/Official/annual/max_temp/",as.character(i),".max_temp.nc")
  tmp <- paste0("Temp Data/",as.character(i)," Temp.nc")
  curl_download(url, tmp) 
}
